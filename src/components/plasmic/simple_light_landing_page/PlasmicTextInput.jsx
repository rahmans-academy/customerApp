...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: BMOwZhaJYxua/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: aHusAjeDqNw3/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: AEySiMGTffEc/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__ef3Sa)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__hbUy)}
              role={"img"}
            />
          ),
